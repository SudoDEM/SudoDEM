"""
 ...
 """
##################################################
#This script is for testing periodic boundary conditions.
##################################################
...
pos = list()
pos.append((4.592, 4.584))
pos.append((1.6, 0.456))
pos.append((2.32, 4.248))
pos.append((3.328,	3.32))
pos.append((3.264,	0.392))
pos.append((2.128,	2.248))
pos.append((0.672,	2.632))
pos.append((1.728,	3.128))
pos.append((3.936,	0.84))
pos.append((2.912,	2.248))
pos.append((2.528,	2.952))
...
O.dt = 1e-6
#O.cell.velGrad=Matrix2(-0.5,0,0,0)
